...
Patch mode:
- فرمت فایل درست شد.
- DB_PATH از config خوانده می‌شود تا روی Railway Volume قابل نگهداری باشد.
- migration های ایمن حفظ شدند.
"""
...
def init():
    ...
    _ensure_column("subs", "price_paid", "INTEGER")
    _ensure_column("subs", "account_name", "TEXT")
